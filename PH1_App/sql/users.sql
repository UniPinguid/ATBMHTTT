...
CREATE USER "100001" IDENTIFIED BY "3411745902"; -- Thanh tra, Giám đốc sở
CREATE USER "100002" IDENTIFIED BY "3911523982"; -- Nghiên cứu
CREATE USER "100003" IDENTIFIED BY "3289123577"; -- Cơ sở y tế

select * from "900001".BENHNHAN;