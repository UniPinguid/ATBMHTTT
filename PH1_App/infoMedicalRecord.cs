...
namespace PH1_App
{
    public partial class infoMedicalRecord : Form
    {
        public static bool is_add_form = false;

        public infoMedicalRecord()
        {
            InitializeComponent();
        ...
        private void infoMedicalRecord_Load(object sender, EventArgs e)
        {
            if (is_add_form == true)
            {
                textBox_maCSYT.Text = "";
                ...
                textBox_tenBS.Text = "";
                textBox_maKhoa.Text = "";
                textBox_chanDoan.Text = "";
                textBox_ketLuan.Text = "";
                textBox_ngayCD.Text = "";
        ...
        private void clickEdit(object sender, EventArgs e)
        {
            ...
            toggleEditableTextbox(textBox_maBN, true);
            ...
            toggleEditableTextbox(textBox_maBS, true);
            toggleEditableTextbox(textBox_tenBS, true);
            toggleEditableTextbox(textBox_maKhoa, true);
            toggleEditableTextbox(textBox_chanDoan, true);
            toggleEditableTextbox(textBox_ketLuan, true);
            toggleEditableTextbox(textBox_ngayCD, true);
        ...
        private void clickSubmit(object sender, EventArgs e)
        {
            ...
            toggleEditableTextbox(textBox_maBN, false);
            ...
            toggleEditableTextbox(textBox_maBS, false);
            toggleEditableTextbox(textBox_tenBS, false);
            toggleEditableTextbox(textBox_maKhoa, false);
            toggleEditableTextbox(textBox_chanDoan, false);
            toggleEditableTextbox(textBox_ketLuan, false);
            toggleEditableTextbox(textBox_ngayCD, false);
        }
